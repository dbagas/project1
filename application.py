...
def project0():
    ...
    return render_template("project0.html")
...
def login():
    ...
    if request.method == "POST":
        ...
        if not request.form.get("username"):
            return render_template("error.html", message="anda harus mengisi username")

        # Ensure password was submitted
        elif not request.form.get("password"):
            return render_template("error.html", message="anda harus mengisi password")
        ...
        if result == None or not check_password_hash(result[2], request.form.get("password")):
            return render_template("error.html", message="username atau password anda salah")
...
def register():
    ...
    if request.method == "POST":
        ...
        if userCheck:
            return render_template("error.html", message="username tersebut telah digunakan")
        ...
        # Check passwords are equal
            ...
            return render_template("error.html", message="password anda salah")
...
def search():
    ...
    if not request.args.get("book"):
        return render_template("error.html", message="anda harus menginputkan kata kunci.")
    ...
    # Books not founded
    if rows.rowcount == 0:
        return render_template("error.html", message="buku tersebut tidak ada di database kami.")
...
def book(isbn):
    ...
    if request.method == "POST":
        ...
        if row2.rowcount == 1:
            ...
            flash("Anda sudah mereview buku ini!!", 'warning')
